...
import com.varxyz.jv251.exception.DuplicatedEntiyException;
...
public class BankService {
   ...
   public void addCustmer(String name, String ssn, String phone, String userId, String passwd) {
      if(!isCustomer(ssn)) {
         customerService.addCustomer(customerService.createCustomer(name, ssn, phone, userId, passwd));
      }else {
      throw new DuplicatedEntiyException(ssn + "is duplicated.");
      }
   ...
   public List<Customer> getAllcuCustomers() {
